    ...
    extend: {
      colors: {
        ...
        status: {
          ...
          "searching-foreground": "hsl(var(--status-searching-foreground))",
          ...
          "journal-submitted": "hsl(var(--status-journal-submitted))",
          "journal-submitted-foreground": "hsl(var(--status-journal-submitted-foreground))",
          validated: "hsl(var(--status-validated))",
          "validated-foreground": "hsl(var(--status-validated-foreground))",
        },
        action: {
          view: "hsl(var(--action-view))",
          "view-foreground": "hsl(var(--action-view-foreground))",
          edit: "hsl(var(--action-edit))",
          "edit-foreground": "hsl(var(--action-edit-foreground))",
          delete: "hsl(var(--action-delete))",
          "delete-foreground": "hsl(var(--action-delete-foreground))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
